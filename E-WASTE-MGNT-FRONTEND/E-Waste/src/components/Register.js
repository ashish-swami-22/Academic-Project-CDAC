          ...
          <form className="row g-3 mt-1">
            ...
            <div className="col-md-6">
              ...
              <input
                ...
                required
              />
              <div className="invalid-feedback fs-6 fw-bold">{econpassword}</div>
            </div>
            ...
            <div className="col-md-6">
              ...
              <div className="invalid-feedback fs-6 fw-bold">{esecurityQues}</div>
            </div>
            <div className="col-md-6">
              ...
              <input
                ...
                required
              />
              <div className="invalid-feedback fs-6 fw-bold">{esecurityAns}</div>
            </div>
